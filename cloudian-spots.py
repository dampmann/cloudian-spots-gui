...
class MainWindow(QWidget):
    ...
    def __init__(self, profile, default_region, username, account_id):
        ...
        self.layout_h1.addWidget(self.inst_type_widget)
        ...
        self.layout_h1.addWidget(self.settings_button)
        self.layout_h1.addStretch()
        self.layout_h3.addStretch()
        self.layout_h3.addWidget(self.run_cosbench_cb)
        self.layout_h3.addWidget(self.cosbench_button)
        self.layout_h3.addWidget(self.install_button)
        self.layout_h3.setAlignment(Qt.AlignTop|Qt.AlignRight)
